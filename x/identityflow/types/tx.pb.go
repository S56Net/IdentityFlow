...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_af84c741d4116541, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_af84c741d4116541, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "identityflow.identityflow.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "identityflow.identityflow.MsgUpdateParamsResponse")
}

func init() {
	proto.RegisterFile("identityflow/identityflow/tx.proto", fileDescriptor_af84c741d4116541)
}

var fileDescriptor_af84c741d4116541 = []byte{
	// 322 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0xca, 0x4c, 0x49, 0xcd,
	0x2b, 0xc9, 0x2c, 0xa9, 0x4c, 0xcb, 0xc9, 0x2f, 0xd7, 0x47, 0xe1, 0x94, 0x54, 0xe8, 0x15, 0x14,
	...
	0x36, 0x70, 0x74, 0x19, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xed, 0xc8, 0x61, 0x9d, 0x74, 0x02,
	0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/identityflow.identityflow.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/identityflow.identityflow.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "identityflow.identityflow.Msg",
	...
	Metadata: "identityflow/identityflow/tx.proto",
}
